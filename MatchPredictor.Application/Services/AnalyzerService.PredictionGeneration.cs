...
public partial class AnalyzerService
{
    ...
    public async Task GeneratePredictionsAsync(string? targetDate = null, string? runReason = null)
    {
        ...
        try
        {
            ...
            // Do not ROI/CLV-suppress at publish: SavePredictions supersedes all markets on touched
            // fixtures, so category suppress would empty those pages. Soft-suppress stays on betslips.
