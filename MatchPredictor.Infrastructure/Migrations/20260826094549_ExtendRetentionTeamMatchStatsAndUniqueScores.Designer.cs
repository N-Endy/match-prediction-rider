...
namespace MatchPredictor.Infrastructure.Migrations
{
    ...
    [Migration("20260826094549_ExtendRetentionTeamMatchStatsAndUniqueScores")]
    partial class ExtendRetentionTeamMatchStatsAndUniqueScores
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatchPredictor.Domain.Models.Betslip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double?>("CombinedDecimalOdds")
                        .HasColumnType("double precision");

                    b.Property<DateTime?>("EarliestKickoffUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int>("TargetMaxSelections")
                        .HasColumnType("integer");

                    b.Property<int>("TargetMinSelections")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BetslipSetId", "SlipNumber")
                        .IsUnique();

                    b.ToTable("Betslips");
                });

            modelBuilder.Entity("MatchPredictor.Domain.Models.BetslipSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("BetslipSelections");
                });

            modelBuilder.Entity("MatchPredictor.Domain.Models.BetslipSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateOnly>("SlipLocalDate")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("SlipLocalDate", "IsCurrent");

                    b.ToTable("BetslipSets");
                });
            ...
            modelBuilder.Entity("MatchPredictor.Domain.Models.ForecastObservation", b =>
                {
                    ...
                    b.Property<string>("SettledSourceEventId")
                        .HasColumnType("text");

                    b.Property<string>("SettledSourceName")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("SettledSourceName", "SettledSourceEventId");
            ...
            modelBuilder.Entity("MatchPredictor.Domain.Models.TeamMatchStats", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<float?>("ExpectedGoalsAgainst")
                        .HasColumnType("real");

                    b.Property<float?>("ExpectedGoalsFor")
                        .HasColumnType("real");
                    ...
                    b.HasIndex("KickoffUtc", "AvailableFromUtc");

                    b.HasIndex("TeamName", "KickoffUtc");

                    b.HasIndex("SourceName", "SourceMatchId", "IsHome")
                        .IsUnique()
            ...
            modelBuilder.Entity("MatchPredictor.Domain.Models.Betslip", b =>
                {
                    b.HasOne("MatchPredictor.Domain.Models.BetslipSet", "BetslipSet")
                        .WithMany("Slips")
                        .HasForeignKey("BetslipSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BetslipSet");
                });

            modelBuilder.Entity("MatchPredictor.Domain.Models.BetslipSelection", b =>
                {
                    b.HasOne("MatchPredictor.Domain.Models.Betslip", "Betslip")
                        .WithMany("Selections")
