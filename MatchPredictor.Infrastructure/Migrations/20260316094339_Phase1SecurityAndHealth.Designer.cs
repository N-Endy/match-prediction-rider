...
namespace MatchPredictor.Infrastructure.Migrations
{
    ...
    [Migration("20260316094339_Phase1SecurityAndHealth")]
    partial class Phase1SecurityAndHealth
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MatchPredictor.Domain.Models.Prediction", b =>
                {
                    ...
                    b.HasIndex("Date", "IsLive");

                    b.HasIndex("Date", "PredictionCategory", "Time");

                    b.HasIndex("Date", "HomeTeam", "AwayTeam", "League");
